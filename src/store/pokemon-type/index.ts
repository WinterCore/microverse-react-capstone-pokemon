...
import {
  ...
  FETCH_POKEMON_TYPE_SUCCESS,
  ActionUnion,
} from './actions';

export type PokemonTypeState = (
  ApiResourceState<PokemonType<NamedApiResource> | null>
);
...
const pokemonReducer: Reducer<PokemonTypeState> = (
  state: PokemonTypeState = INITIAL_STATE,
  action: ActionUnion,
) => {
  switch (action.type) {
